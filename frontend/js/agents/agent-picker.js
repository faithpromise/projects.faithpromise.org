(function (module) {
    ...
    function directive() {
        return {
            template:         '<select class="CustomSelect-control" ng-model="vm.agent" ng-options="agent.name for agent in vm.agents" ng-change="vm.on_change_handler()" tabindex="2"></select>',
            restrict:         'E',
